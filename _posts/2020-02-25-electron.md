---
layout: post
tags: [HTML, CSS, Javascript, Jekyll, freecodecamp.org, electron.atom.io, https://scrimba.com, Flexbox, Grid, custom properties]
---
# ELECTRON (développer des applications multiplateformes en HTML, CSS, JS) – Fully Responsive

* Static HTML templates
* Using CSS to be customizable as possible (custom properties)
...
## The header area (ds header) - HTML
...
Deux __ dans class="nav__list" car cette liste est un sous contenant de class="nav" (pas obligatoire mais utile à la compréhension du code).

## Intro section (ds body) - HTML
...
Section__title section__title--services (__title-services modifie le __title par défaut).  
Id=#home permet de creer un lien (ancre) pour le bouton home de nav__list.  
Les partie du blog sont définient par sections.
...
```
## Setting up the custom properties and genereral style - CSS
